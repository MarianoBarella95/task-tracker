...
This is Task Tracker, a CLI application that allows you to maintain a lists of tasks, and perform CRUD operations on them. This project is part of the [Backend Roadmap](https://roadmap.sh/projects/task-tracker) in [roadmap.sh](roadmap.sh).
